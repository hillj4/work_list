...
class InspectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inspection" do
    assert_difference('Inspection.count') do
      post inspections_url, params: { inspection: { description: @inspection.description, title: @inspection.title } }
    end
  ...
  test "should update inspection" do
    patch inspection_url(@inspection), params: { inspection: { description: @inspection.description, title: @inspection.title } }
